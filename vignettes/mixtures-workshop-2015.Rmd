...
sl_mix_lib = c("SL.mean", "SL.lm", "SL.ranger")
sl_mix_1 = function(...) mixture_backfit_sl(..., estimator_mixture = sl_mix_lib)

sl_mix_lib2 = c("SL.mean", "SL.lm", "SL.ranger", "tmle.SL.dbarts2")
sl_mix_2 = function(...) mixture_backfit_sl(..., estimator_mixture = sl_mix_lib2)
...
result = tlmixture(df,
                   ...
                   estimator_outcome = c("SL.mean", "SL.lm", "SL.ranger"),
                   #cluster_exposures = cluster_exposures,
                   #mixture_fn = tlmixture::mixture_glm,
                   #mixture_fn = tlmixture::mixture_lm,
                   #mixture_fn = tlmixture::mixture_backfit_lm,
                   mixture_fn = mixture_backfit_lm,
                   #mixture_fn = mixture_backfit_sl,
                   #mixture_fn = sl_mix_1,
...
result$groups
summary(result$groups$mixture_df)
...
result = tlmixture(df, outcome = task$outcome,
                   ...
                   quantiles_mixtures = 4,
                   #quantiles_mixtures = 5,
                   estimator_outcome = c("SL.lm", estimators),
                   cluster_exposures = cluster_exposures,
                   #mixture_fn = sl_mix_2,
                   #folds_cvtmle = folds_cvtmle,
                   #folds_cvtmle = 3,
